...
class Tour extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['Nombre_tour','Email_contacto_tour','Foto_tours','Detalle_tour','Recojo_hotel','Punto_encuentro','cantidad_dias_tour','cantidad_noches_tour','Horario_inicio','Hora_fin','Entregan_agua','Para_discapacitados','Con_bano','Pais_Id_Pais','Ciudad_Id_Ciudad','Zona_Id_Zona'];
    ...
    {
        return $this->hasMany('App\Models\DetalleTour', 'Id_tours', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\CarritoTour', 'id_tours', 'id');
    }
