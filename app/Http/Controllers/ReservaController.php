...
class ReservaController extends Controller
{
    ...
    {
        $reservas = Reserva::orderBy('created_at', 'desc')->paginate();
    ...
    public function show($id)
    {
        ...
        $detalleReservas = $reserva->detalleReservas;
        $usuario = $reserva->user;

        return view('reserva.show', compact('reserva','detalleReservas','usuario'));
    }
