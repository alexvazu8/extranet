...
class RoleHasPermissionController extends Controller
{
    ...
    {
        $roleHasPermissions = RoleHasPermission::orderBy("role_id")->paginate();
    ...
    public function create()
    {
        ...
        return view('role-has-permission.create', compact('roleHasPermission','permiso','role'));
    }
    ...
    public function edit($id)
    {
        ...
        $role= new Role();
        $permiso= new Permission();
        return view('role-has-permission.edit', compact('roleHasPermission','permoso','role'));
    }
