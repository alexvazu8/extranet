<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('Usuario_id', $reserva->Usuario_id, ['class' => 'form-control' . ($errors->has('Usuario_id') ? ' is-invalid' : ''), 'placeholder' => 'Usuario Id']) }}
            {!! $errors->first('Usuario_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Email_contacto_reserva') }}
            {{ Form::text('Email_contacto_reserva', $reserva->Email_contacto_reserva, ['class' => 'form-control' . ($errors->has('Email_contacto_reserva') ? ' is-invalid' : ''), 'placeholder' => 'Email Contacto Reserva']) }}
            {!! $errors->first('Email_contacto_reserva', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Comentarios') }}
            {{ Form::text('Comentarios', $reserva->Comentarios, ['class' => 'form-control' . ($errors->has('Comentarios') ? ' is-invalid' : ''), 'placeholder' => 'Comentarios']) }}
