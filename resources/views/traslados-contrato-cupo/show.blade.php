                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('traslados-contrato-cupos.index',[$trasladosContratoCupo->Empresa_traslado_tipo_movilidades_id,$trasladosContratoCupo->Servicio_traslado_Id]) }}"> Back</a>
                        </div>
                    </div>
