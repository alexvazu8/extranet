<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::file('url_foto_tour') }}
            {!! $errors->first('url_foto_tour', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('tour_id') }}
            {{ Form::select('tour_id',$tour->pluck('Nombre_tour', 'id') ,$fotosTour->tour_id, ['class' => 'form-control' . ($errors->has('tour_id') ? ' is-invalid' : ''), 'placeholder' => 'Tour Id']) }}
