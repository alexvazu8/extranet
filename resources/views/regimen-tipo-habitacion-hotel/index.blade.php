                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('regimen-tipo-habitacion-hotels.createconidtipohab',$id_tipo_habitacion_hotel) }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($regimenTipoHabitacionHotels as $regimenTipoHabitacionHotel)
                                        <tr>
											...
											<td>{{ $regimenTipoHabitacionHotel->tipoHabitacionHotel->Nombre_Habitacion }}</td>
											<td>{{ $regimenTipoHabitacionHotel->regimen->nombre_regimen}}</td>
