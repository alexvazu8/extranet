<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Fecha_de') }}
            {{ Form::date('Fecha_de', $toursContratoCupo->Fecha_de, ['class' => 'form-control' . ($errors->has('Fecha_de') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Desde']) }}
            {!! $errors->first('Fecha_de', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Fecha_hasta') }}
            {{ Form::date('Fecha_hasta', $toursContratoCupo->Fecha_hasta, ['class' => 'form-control' . ($errors->has('Fecha_hasta') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Hasta']) }}
            {!! $errors->first('Fecha_disponible', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Edad_menor') }}
            {{ Form::number('Edad_menor', $toursContratoCupo->Edad_menor, ['class' => 'form-control' . ($errors->has('Edad_menor') ? ' is-invalid' : ''), 'placeholder' => 'Edad Menor']) }}
            {!! $errors->first('Fecha_disponible', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Cupo') }}
            {{ Form::number('Cupo', $toursContratoCupo->Cupo, ['class' => 'form-control' . ($errors->has('Cupo') ? ' is-invalid' : ''), 'placeholder' => 'Cupo']) }}
            {!! $errors->first('Cupo', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Release') }}
            {{ Form::number('Release', $toursContratoCupo->Release, ['class' => 'form-control' . ($errors->has('Release') ? ' is-invalid' : ''), 'placeholder' => 'Release','max'=>'10']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('Tours_id', $tours->id, ['class' => 'form-control' . ($errors->has('Tours_id') ? ' is-invalid' : ''), 'placeholder' => 'Tours Id']) }}
            {!! $errors->first('Tours_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Nombre del Tour') }}
            {{ Form::text('Tours_Nombre', $tours->Nombre_tour, ['class' => 'form-control' , 'placeholder' => 'Tours']) }}
