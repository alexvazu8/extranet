                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('empresa-traslado-tipo-movilidades-contrato-cupos.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($empresaTrasladoTipoMovilidadesContratoCupos as $empresaTrasladoTipoMovilidadesContratoCupo)
                                        <tr>
											...
											<td>{{ $empresaTrasladoTipoMovilidadesContratoCupo->Empresa_traslado_tipo_movilidades_id }}</td>

                                            <td>
                                                <form action="{{ route('empresa-traslado-tipo-movilidades-contrato-cupos.destroy',$empresaTrasladoTipoMovilidadesContratoCupo->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('empresa-traslado-tipo-movilidades-contrato-cupos.show',$empresaTrasladoTipoMovilidadesContratoCupo->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('empresa-traslado-tipo-movilidades-contrato-cupos.edit',$empresaTrasladoTipoMovilidadesContratoCupo->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
