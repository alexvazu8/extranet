                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('servicio-traslados.index',$servicioTraslado->empresa_traslado_tipo_movilidades_Id) }}"> Back</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <strong>Tipo Servicio Transfer:</strong>
                            {{ $servicioTraslado->Tipo_servicio_transfer }}
                        </div>
                        <div class="form-group">
