<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('Hotel_Id_Hotel', $hotel, $tipoHabitacionHotel->Hotel_Id_Hotel, ['class' => 'form-control' . ($errors->has('Hotel_Id_Hotel') ? ' is-invalid' : ''), 'placeholder' => 'Hotel Id Hotel']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::select('Tipo_Habitacion_general_Id_tipo_Habitacion_general',$tipoHabitacionGeneral, $tipoHabitacionHotel->Tipo_Habitacion_general_Id_tipo_Habitacion_general, ['class' => 'form-control' . ($errors->has('Tipo_Habitacion_general_Id_tipo_Habitacion_general') ? ' is-invalid' : ''), 'placeholder' => 'Tipo Habitacion General Id Tipo Habitacion General']) }}
