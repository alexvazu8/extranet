<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('Numero_Adultos', $detalleReserva->Numero_Adultos, ['class' => 'form-control' . ($errors->has('Numero_Adultos') ? ' is-invalid' : ''), 'placeholder' => 'Numero Adultos']) }}
            {!! $errors->first('Numero_Adultos', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Numero_menores') }}
            {{ Form::text('Numero_menores', $detalleReserva->Numero_menores, ['class' => 'form-control' . ($errors->has('Numero_menores') ? ' is-invalid' : ''), 'placeholder' => 'Numero Menores']) }}
