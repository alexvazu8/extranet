...
__webpack_require__(/*! ./ciudade */ "./resources/js/ciudade.js");

__webpack_require__(/*! ./zona */ "./resources/js/zona.js");
...
function Seleccionarycambiartour() {
  var Id_Pais = $(this).val();
  $.get('/hotels/ciudades/' + Id_Pais, function (data) {
    if (!Id_Pais) $('#Ciudad_Id_Ciudad').html('<option value="">Seleccione Ciudad</option>');
    var Html_select = '<option value="">Seleccione Ciudad</option>';
...
function SeleccionarycambiarZona() {
  ...
  $.get('/hotels/zonas/' + Id_Ciudad, function (data) {
    if (!Id_Ciudad) $('#Id_Zona').html('<option value="">Seleccione Ciudad</option>');
    var Html_select = '<option value="">Seleccione Ciudad</option>';
...
function SeleccionarycambiarZonaTour() {
  var Id_Ciudad = $(this).val();
  $.get('/hotels/zonas/' + Id_Ciudad, function (data) {
    if (!Id_Ciudad) $('#Zona_Id_Zona').html('<option value="">Seleccione Ciudad</option>');
    var Html_select = '<option value="">Seleccione Ciudad</option>';
